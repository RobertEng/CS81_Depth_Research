...
def coco_turker_task(hit_id):
	...
	return render_template('TurkAnnotationGUI_v6.html',
						   subj_id_list = str(res["_coco_subjs_ids"]),
						   keypoint_labels = res_kpts,
						   dataset = "coco")

# Endpoint needed to resort the keypoints
@app.route("/cocoa_depth/human/sort", methods=['GET'])
def human_turker_task_sort():
	...
	# KEYCMPS_FILE = "/Users/Robert/Documents/Caltech/EE148/ee148project/keycmps.json"
	KEYCMPS_FILE = "/Users/Robert/Documents/Caltech/CS81_Depth_Research/results/caltech_results_keycmps.json"
	with open(KEYCMPS_FILE, "r") as f:
		keycmps = json.load(f)
		print keycmps

	return render_template('getMergeData.html',
...
# def turker_task(hit_id, _mongo_coll_2, _mongo_coll_3):
# 	res_kpts = _mongo_coll_2.find_one()
# 	res_kpts = json.dumps(res_kpts["_keypoint_labels"])
# 	res = _mongo_coll_3.find_one({"_amt_hit_id": int(hit_id)})
# 	print "You just requested the mturk page -> " + str(hit_id) + " " + str(res)
...
# 	print res
# 	return render_template('TurkAnnotationGUI_v6.html',
# 						   subj_id_list = str(res["human_subjs_ids"]),
# 						   keypoint_labels = res_kpts)
...
# def GetTrialData(_mongo_coll_1):
# 	_coco_subj_id = request.json['_coco_subj_id']
# 	print "_coco_subj_id is " + str(_coco_subj_id)
...
# 	print "ok 1"
# 	return_dict["_image_keypoints"] = res_1["_image_keypoints"]
# 	#return_dict["_image_mapster_areas"] = res_2["_image_mapster_areas"]
# 	print res_1
# 	print len(res_1['_image_keypoints'])
# 	print "ok 2"
# 	return_dict["_coco_img_src"] = res_1["_coco_img_src"]
# 	print "ok 3"
# 	return_dict["_keypoints_bbox"] = res_1["_keypoints_bbox"]
# 	print "ok 4"
# 	#tmp_dict = {}
# 	#for key in res_2_obj_info_dict.keys():
# 	#   print key
# 	#   print res_2_obj_info_dict[key]["_coco_cat_name"]
# 	#   tmp_dict[key] = res_2_obj_info_dict[key]["_coco_cat_name"]

# 	#print "ok"
# 	#print tmp_dict
# 	#return_dict["_obj_info_dict"] = json.dumps(tmp_dict)
...
def coco_PostTrialResults():
	...
	# _trial_flag = request.json["_trial_flag"]
	# print "_trial_flag: " + str(_trial_flag)
	...
	# _trial_comment = request.json["_trial_comment"]
	# print "_trial_comment: " + _trial_comment
...
# def PostTrialResults(_mongo_coll_7):
# 	_coco_subj_id = request.json["_coco_subj_id"]
# 	print "annotated subject: " + str(_coco_subj_id)
...
def IsNewWorker(_mongo_coll_5):
	...
	if ( bool(res) == False ):
		...
		res = _mongo_coll_5.insert({'_worker_id':_worker_id,'_worker_exp':0})
	else:
		worker_exp = res['_worker_exp']+1
		_mongo_coll_5.update({'_worker_id':res['_worker_id']},{ '$set' : {'_worker_exp':res['_worker_exp']+1}, '$currentDate' : {'lastModified':True } })

...
for subject_id in SUBJECT_IDS:
    ...
    for video_filename in VIDEOS:
        ...
        if subject_id == 9 and camera_id == 54138969 and video_filename == "SittingDown 1.54138969.mp4": continue
        if subject_id == 9 and camera_id == 55011271 and video_filename == "SittingDown 1.55011271.mp4": continue
        if subject_id == 9 and camera_id == 58860488 and video_filename == "SittingDown 1.58860488.mp4": continue
        if subject_id == 9 and camera_id == 60457274 and video_filename == "SittingDown 1.60457274.mp4": continue
        if subject_id == 11 and camera_id == 54138969 and action_name == 'Directions': continue
...
with open('%s/human36m_train_17.json'%(ANNOTATIONS_DIR),'wb') as fp:
